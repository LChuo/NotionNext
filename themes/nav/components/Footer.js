  ...
  return (
        ...
        >
            ...
            <div className='flex justify-center'>
                <div><i className='text-xs mx-1 animate-pulse fas fa-seedling' /><a href={siteConfig('LINK')} className='underline font-bold text-gray-500 dark:text-gray-300 '>{siteConfig('AUTHOR')}</a>.<br /></div>
                © {`${copyrightDate}`}
            </div>
