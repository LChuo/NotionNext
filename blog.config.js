...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'typography', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'takumori', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '小头你又在发力了', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kouh.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '屁话', // 网站关键词 英文逗号隔开
